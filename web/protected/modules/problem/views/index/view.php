                ...
                <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-2 col-xs-offset-2 col-lg-10 col-md-10 col-sm-10 col-xs-10">
                    <div class="form-control-static">
                        ...
                        <?php if(!Yii::app()->user->checkAccess('finder')): ?>
                            <?php if(Yii::app()->user->checkAccess('admin')): ?>
                                <?php if(!in_array($problem->status, array(ProblemService::WAIT_CHECKING, ProblemService::BE_QUALIFIED, ProblemService::BE_CANCELED))): ?>
                            ...
                            <?php if(Yii::app()->user->checkAccess('unit')): ?>
                                ...
                                <?php endif; ?>
                                <?php if(in_array($problem->status, array(ProblemService::BE_DEALING, ProblemService::WAIT_CHECKING, ProblemService::BE_BACKING))): ?>
