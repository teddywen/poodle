    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="span5">
                        <form class="form-horizontal check_assisted_form" action="<?php echo Yii::app()->baseUrl;?>/problem/problemFlow/applyAssitedProblem" method="post" onsubmit="return false;">
