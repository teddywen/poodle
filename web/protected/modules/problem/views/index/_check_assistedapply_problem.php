<!-- Modal -->
<div class="modal fade" id="check_assisted_modal" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="width: 750px;">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">重新分配联动</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11">
                        <form class="check_assisted_form" action="<?php echo Yii::app()->baseUrl;?>/problem/problemFlow/modifyApplyAssited" method="post" onsubmit="return false;">
                        		...
                        		<?php endif;?>
                                    <td style="width: 150px;">
                                        <label class="checkbox">
                                            <input type="checkbox" name="user_ids[]" value="<?php echo $user->id;?>" <?php if(in_array($user->id, $unit_uids)):?>checked="checked"<?php endif;?> style="margin-left: 0px;" /><label><?php echo $user->username;?></label>
                                        </label>
                                    </td>
                            ...
                            <div>
                                <button id="button" class="btn btn-info btn_check_assistedapply">确定</button>
